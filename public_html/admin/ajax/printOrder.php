...
if(isset($_POST['id'])){
    ...
    while($row = $query->fetch()):
        ...
        $dataArray['client']['num_pedidos'] = $num_pedidos > 1 ? $num_pedidos.' Pedidos' : 'NOVO CLIENTE';
        ...
        <div><center><h2>//// Pedido Nº {$dataArray['order']['id']} ////</h2></center></div>";
        ...
        $orderHtml .="<div>{$dataArray['client']['num_pedidos']}</div>";
        $orderRaw .= "{$dataArray['client']['num_pedidos']}\n";
