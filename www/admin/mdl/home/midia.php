...
if($_POST['form'] == 'form') {
	...
	if($prosseguir && empty($up_multiple)) {
		$form_return .= aviso_green("Imagem enviada com sucesso!<br><br>Link: <a href='$caminho_img' target='_blank'><b>http://www.pedidu.com.br$caminho_img</b></a>");
	}
	...
	if($prosseguir && !empty($up_multiple)) {
		...
		foreach ($caminho_img as $atual) {
			$return .= "<a href='$atual' target='_blank'><b>http://www.pedidu.com.br$atual</b></a><br>";
		}
