...
<body  id="qz-page" role="document" onmouseover="document.getElementById('silence').play()">
    <Header>
      <div class="infoHeaders">
          ...
          <div class="options">
            <a href="./statusproduto" id="alterStatus"> Alterar Status </a>
          </div>
      </div>
    ...
    <div class="configs">
        ...
        <div id="buttons">
          <input type="number" placeholder="Digite aqui a quantidade de mesas." id='number' value="<?php echo $rowMesa ?>"style="height:40px; margin-top:10px;padding-left:5px;">
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    ...
    <script src="./js/mothodsPayaments.js"></script>
    <script src='./js/closeTable.js'></script>
...
<script src="js/numberTables.js"></script>
<script src="js/waiter.js"></script>
<script src="js/impressqz.js"></script>
